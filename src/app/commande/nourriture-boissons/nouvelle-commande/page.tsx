...
export default function NouvelleCommandePage() {
  ...
  const confirmGenerateRecapEmail = () => {
    ...
    const archivedSession: ArchivedCommandSession = {
      ...
      supplierAggregatedOrders: [], // Initialisé comme vide, sera rempli par la page récap fournisseur
      supplierOrdersGeneratedAt: undefined,
    };
    ...
    <div className="container mx-auto p-4">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold">Nouvelle Session de Commande</h1>
        </div>
